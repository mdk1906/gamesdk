 ...
 */
@interface NSObject (OrangeYYModel)
 ...
 */
@interface NSArray (OrangeYYModel)
 ...
 */
@interface NSDictionary (OrangeYYModel)
...
/**
 ...
 There's no need to add '<OrangeYYModel>' to your class header.
 */
@protocol OrangeYYModel <NSObject>
@optional
