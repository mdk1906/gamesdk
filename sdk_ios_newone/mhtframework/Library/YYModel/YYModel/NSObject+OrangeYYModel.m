...
+ (instancetype)metaWithClassInfo:(OrangeYYClassInfo *)classInfo propertyInfo:(YYClassPropertyInfo *)propertyInfo generic:(Class)generic {
...
- (instancetype)initWithClass:(Class)cls {
    OrangeYYClassInfo *classInfo = [OrangeYYClassInfo classInfoWithClass:cls];
    ...
    if ([cls respondsToSelector:@selector(modelPropertyBlacklist)]) {
        NSArray *properties = [(id<OrangeYYModel>)cls modelPropertyBlacklist];
        if (properties) {
    ...
    if ([cls respondsToSelector:@selector(modelPropertyWhitelist)]) {
        NSArray *properties = [(id<OrangeYYModel>)cls modelPropertyWhitelist];
        if (properties) {
    ...
    if ([cls respondsToSelector:@selector(modelContainerPropertyGenericClass)]) {
        genericMapper = [(id<OrangeYYModel>)cls modelContainerPropertyGenericClass];
        if (genericMapper) {
    ...
    OrangeYYClassInfo *curClassInfo = classInfo;
    ...
    if ([cls respondsToSelector:@selector(modelCustomPropertyMapper)]) {
        NSDictionary *customMapper = [(id <OrangeYYModel>)cls modelCustomPropertyMapper];
...
static id ModelToJSONObjectRecursive(NSObject *model) {
    ...
    if (modelMeta->_hasCustomTransformToDictionary) {
        BOOL suc = [((id<OrangeYYModel>)model) modelCustomTransformToDictionary:dic];
        if (!suc) return nil;
    }
    return result;
}
...
@implementation NSObject (OrangeYYModel)
...
- (BOOL)yy_modelSetWithDictionary:(NSDictionary *)dic {
    ...
    if (modelMeta->_hasCustomWillTransformFromDictionary) {
        dic = [((id<OrangeYYModel>)self) modelCustomWillTransformFromDictionary:dic];
        if (![dic isKindOfClass:[NSDictionary class]]) return NO;
    }
    ...
    if (modelMeta->_hasCustomTransformFromDictionary) {
        return [((id<OrangeYYModel>)self) modelCustomTransformFromDictionary:dic];
    }
    return YES;
}
...
@implementation NSArray (OrangeYYModel)
...
@implementation NSDictionary (OrangeYYModel)
